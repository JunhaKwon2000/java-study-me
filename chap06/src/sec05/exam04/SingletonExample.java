...
public class SingletonExample {
	...
	public static void main(String[] args) {
		...
		// Singleton s1 = new Singleton(); // compile error - not visible
		
		Singleton instance1 = Singleton.getInstance();
		Singleton instance2 = Singleton.getInstance();
		
		System.out.println(instance1); // refers to the one and only object
		System.out.println(instance2); // refers to the one and only object

		
		if (instance1 == instance2) System.out.println("Same singleton obejct");
