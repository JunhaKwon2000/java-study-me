...
public class CarExample {
	...
	public static void main(String[] args) {
		...
		// System.out.println(car.speed); // compile error - field is not visible(private)
		
		// car.speed = -50 // when not private, this can't be stopped, so we use a setter with checking functionality
		
		
		// wrong change in speed - the setter checks for correct value
		car.setSpeed(-50);
