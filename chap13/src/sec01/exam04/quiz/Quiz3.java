...
//		- 축구공: 3000원
	...
	public static void main(String[] args) {
		...
		Set<Equipment> intersect = new HashSet<>();
		intersect.addAll(storage1);
		intersect.retainAll(storage2);
		Iterator<Equipment> iter2 = intersect.iterator();
		while(iter2.hasNext()) System.out.println(iter2.next());
		
		System.out.println("*** 차집합 ***");
		Set<Equipment> except = new HashSet<>();
		except.addAll(storage1);
		except.removeAll(storage2);
		Iterator<Equipment> iter3 = except.iterator();
